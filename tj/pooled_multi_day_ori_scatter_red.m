%FINISH ADDING LACZ EXP LIST AND THEN DO LACZ ANIMALS
%clear everything
clear all
clear all global
clc
...
arc_k_d1_d2_match_tune_all = [];
arc_k_d2_match_tune_all = [];
arc_k_d1_d3_match_tune_all = [];
arc_k_d3_match_tune_all = [];
...
for idata = 1:length(arc_d1_ori_all)
    ...
    arc_prefori_d1_d2_match_tune = arc_d1_ori_all(idata).prefOri(1, arc_tuned_matched_d2);
    arc_prefori_d1_d2_match_tune_all = [arc_prefori_d1_d2_match_tune_all arc_prefori_d1_d2_match_tune];
    arc_prefori_d2_match_tune = arc_d2_ori_all(idata).prefOri(1, arc_tuned_matched_d2);
    arc_prefori_d2_match_tune_all = [arc_prefori_d2_match_tune_all arc_prefori_d2_match_tune];    

    arc_prefori_d1_d3_match_tune = arc_d1_ori_all(idata).prefOri(1, arc_tuned_matched_d3);
    arc_prefori_d1_d3_match_tune_all = [arc_prefori_d1_d3_match_tune_all arc_prefori_d1_d3_match_tune];
    arc_prefori_d3_match_tune = arc_d3_ori_all(idata).prefOri(1, arc_tuned_matched_d3);
    arc_prefori_d3_match_tune_all = [arc_prefori_d3_match_tune_all arc_prefori_d3_match_tune];    

    arc_d1_k_tuned = arc_d1_k_max_all(idata).k1(arc_tuned_d1);
    arc_d1_k_tuned_all = [arc_d1_k_tuned_all arc_d1_k_tuned];
    arc_d1_max_tuned = arc_d1_k_max_all(idata).max_dfof(arc_tuned_d1);
    arc_d1_max_tuned_all = [arc_d1_max_tuned_all arc_d1_max_tuned];

    arc_d1_k_any = arc_d1_k_max_all(idata).k1;
    arc_d1_k_any_all = [arc_d1_k_any_all arc_d1_k_any];
    arc_d1_max_any = arc_d1_k_max_all(idata).max_dfof;
    arc_d1_max_any_all = [arc_d1_max_any_all arc_d1_max_any];

 
    arc_k_d1_d2_match_tune = arc_d1_k_max_all(idata).k1(arc_tuned_matched_d2);
    arc_k_d1_d2_match_tune_all = [arc_k_d1_d2_match_tune_all arc_k_d1_d2_match_tune];
    arc_k_d2_match_tune = arc_d2_k_max_all(idata).k1(arc_tuned_matched_d2);
    arc_k_d2_match_tune_all = [arc_k_d2_match_tune_all arc_k_d2_match_tune];

    arc_k_d1_d3_match_tune = arc_d1_k_max_all(idata).k1(arc_tuned_matched_d3);
    arc_k_d1_d3_match_tune_all = [arc_k_d1_d3_match_tune_all arc_k_d1_d3_match_tune];
    arc_k_d3_match_tune = arc_d3_k_max_all(idata).k1(arc_tuned_matched_d3);
    arc_k_d3_match_tune_all = [arc_k_d3_match_tune_all arc_k_d3_match_tune];
...
subplot(2,1,2);
scatter(arc_prefori_d1_d3_match_all, arc_prefori_d3_match_all, 'filled', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', 'y', 'LineWidth', 0.8);
%hold on
