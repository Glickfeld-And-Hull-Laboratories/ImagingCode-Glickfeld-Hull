...
data_avg = mean(data(:,:,6001:6500),3); %mean of pixel values over selected range of frames
...
data_dfof = (data_trial-data_f)./data_f; %frames x cells x trials
...
figure; errorbar(pop_avg_per_trial, pop_se_per_trial);
...
figure; errorbar(cell_avg_trial, cell_se_trial);



save(fullfile(fnout, [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_keyvars.mat']),'pop_avg_per_trial', 'pop_std_per_trial', 'pop_se_per_trial', ...
    'cell_avg_trial', 'cell_std_trial', 'cell_se_trial')

save(fullfile(fnout, [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_trialData.mat']),'data_dfof', 'data_trial', 'data_f' )
