...
realfnout = '\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_Staff\home\tj\Analysis\Analysis\2P\darklight\pooled\four_session'; %folder to save files 
...
print(fullfile(realfnout, ['4d_dark_pool_prefori_change.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['4d_dark_pool_k_vals.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['4d_dark_pool_max_vals.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['4d_dark_pool_reliability_vals.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['d1_to_others_4d_dark_pool_prefori_change.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['median_split_4d_dark_pool_prefori_change.pdf']), '-dpdf', '-bestfit')

%do the same as above with the 7d and combined data now!!!***

%%
%% SAME AS ABOVE BUT 7d DARK HOUSING
%%
...
%%
%median split analysis for 7d dark group
fig = figure;
% sgtitle('Pref Ori Changes')
a=subplot(2,2,1)
h=cdfplot(bot_d1_d2_pref_d_all);
...
%%
%% THIS IS FOR BOTH 4 AND 7d DARK COMBINED
%%
...
print(fullfile(realfnout, ['ALL_dark_pool_prefori_change.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['ALL_dark_pool_k_vals.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['ALL_dark_pool_max_vals.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['ALL_dark_pool_reliability_vals.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['d1_to_others_ALL_dark_pool_prefori_change.pdf']), '-dpdf', '-bestfit')


%%
%median split analysis for ALL days dark group
fig = figure;
% sgtitle('Pref Ori Changes')
a=subplot(2,2,1)
h=cdfplot(bot_d1_d2_pref_d_all);
...
print(fullfile(realfnout, ['median_split_ALL_dark_pool_prefori_change.pdf']), '-dpdf', '-bestfit')
