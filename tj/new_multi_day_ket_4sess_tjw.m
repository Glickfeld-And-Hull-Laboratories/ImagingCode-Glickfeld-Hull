...
% fnout = '\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_Staff\home\tj\Analysis\Analysis\2P\reverse_match'; %folder to load files from
newfnout = '\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_Staff\home\tj\Analysis\Analysis\2P\ket_4sess\'; %folder to save files to
...
%img_point: 1 = day 1 (pre-ket), 2 = day 3 (1 ket dose), 3 = day 5 (2 ket
%dose), 4 = day 7 (3 ket dose)
...
%k and max vals
d1_k_and_max = load(fullfile(fnout, [date_d1 '_' mouse], [date_d1 '_' mouse '_' ref_str_d1], [date_d1 '_' mouse '_' ref_str_d1 '_' 'k_and_max_vals.mat']));
d2_k_and_max = load(fullfile(fnout, [date_d2 '_' mouse], [date_d2 '_' mouse '_' ref_str_d2], [date_d2 '_' mouse '_' ref_str_d2 '_' 'k_and_max_vals.mat']));
d3_k_and_max = load(fullfile(fnout, [date_d3 '_' mouse], [date_d3 '_' mouse '_' ref_str_d3], [date_d3 '_' mouse '_' ref_str_d3 '_' 'k_and_max_vals.mat']));
d4_k_and_max = load(fullfile(fnout, [date_d4 '_' mouse], [date_d4 '_' mouse '_' ref_str_d4], [date_d4 '_' mouse '_' ref_str_d4 '_' 'k_and_max_vals.mat']));
...
d1_k = d1_k_and_max.k1(match_all);
d2_k = d2_k_and_max.k1(match_all);
d3_k = d3_k_and_max.k1(match_all);
d4_k = d4_k_and_max.k1(match_all);

d1_max = d1_k_and_max.max_dfof(match_all);
d2_max = d2_k_and_max.max_dfof(match_all);
d3_max = d3_k_and_max.max_dfof(match_all);
d4_max = d4_k_and_max.max_dfof(match_all);
...
m=cdfplot(d4_k);
set(m, 'LineStyle', '-', 'Color', [.8 .8 .8], 'LineWidth',1);
...
legend(['Days 1 to 3'], ['Days 1 to 5'], ['Days 1 to 7'], 'Location', 'southeast')
xlim([0 90])
...
%%
d_score_prefori_1sess = [d_score_prefori_d1_d2 d_score_prefori_d2_d3 d_score_prefori_d3_d4];
d_score_prefori_2sess = [d_score_prefori_d1_d3 d_score_prefori_d2_d4];
d_score_prefori_3sess = [d_score_prefori_d1_d4];
...
set(j, 'LineStyle', '-', 'Color', [.5 .5 .5], 'LineWidth',1);
l=cdfplot(d_score_prefori_3sess);
set(l, 'LineStyle', '-', 'Color', [.8 .8 .8], 'LineWidth',1);
