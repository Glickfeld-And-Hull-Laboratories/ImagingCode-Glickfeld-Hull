...
print(fullfile(realfnout, ['tj_arcprom_changeprefcdf_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_arcprom_kbysession_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_arcprom_kallsessions_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_arcprom_d1_k_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_arcprom_maxbysession_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_arcprom_maxallsessions_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_arcprom_d1_max_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_arcprom_reliabilitybysession_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_arcprom_reliabilityallsessions_redVgreen.pdf']), '-dpdf', '-bestfit')
...
xlabel(['Change in Pref Ori'])
ylabel(['% of cells'])
title(['Bottom 50% Responsivity (Arc Prom)'])
...
xlabel(['Change in Pref Ori'])
ylabel(['% of cells'])
title(['Top 50% Responsivity (Arc Prom)'])
...
print(fullfile(realfnout, ['tj_arcprom_medsplit_changeprefcdf_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_arcprom_medsplit_changeprefcdf_ALLDAYS_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_changeprefcdf_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_kbysession_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_kallsessions_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_d1_k_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_maxbysession_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_maxallsessions_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_d1_max_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_reliabilitybysession_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_reliabilityallsessions_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_medsplit_changeprefcdf_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_lacz_medsplit_changeprefcdf_ALLDAYS_redVgreen.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_allmice_changeprefcdf_red_.pdf']), '-dpdf', '-bestfit')
...
set(m, 'LineStyle', '--', 'Color', 'k', 'LineWidth',2);
legend(['Ses1 - 2 (Arc Prom)'], ['Ses1 - 3 (Arc Prom)'], ['Ses1 - 2 (LacZ)'], ['Ses1 - 3 (LacZ)'], 'Location', 'southeast')
xlim([0 90])
xlabel(['Change in Pref Ori'])
ylabel(['% of cells'])
...
print(fullfile(realfnout, ['tj_allmice_medsplit_changeprefcdf_green_red_.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_allmice_medsplit_changeprefcdf_ALLDAYS_red_.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_allmice_wide_sharp_changeprefcdf_ALLDAYS_red_.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_allmice_medsplit_changeprefcdf_ALLDAYS_green_.pdf']), '-dpdf', '-bestfit')
...
% sgtitle('Pref Ori Changes')
% a=subplot(2,2,1)
h=cdfplot(arc_green_wide_pref_d_all);
set(h, 'LineStyle', '-', 'Color', 'g', 'LineWidth',2);
hold on
j=cdfplot(arc_green_sharp_pref_d_all);
set(j, 'LineStyle', '--', 'Color', 'g', 'LineWidth',2);
l=cdfplot(lacz_green_wide_pref_d_all);
set(l, 'LineStyle', '-', 'Color', 'k', 'LineWidth',2);
m=cdfplot(lacz_green_sharp_pref_d_all);
set(m, 'LineStyle', '--', 'Color', 'k', 'LineWidth',2);
legend(['Wide (Arc)'], ['Sharp (Arc)'], ['Wide (LacZ)'], ['Sharp (LacZ)'], 'Location', 'southeast')
xlim([0 90])
xlabel(['Change in Pref Ori'])
...
print(fullfile(realfnout, ['tj_allmice_wide_sharp_changeprefcdf_ALLDAYS_green_.pdf']), '-dpdf', '-bestfit')
...
title(['KRAB Cells'])
hold off
print(fullfile(realfnout, ['tj_allmice_maxallsessions_red_.pdf']), '-dpdf', '-bestfit')
...
title(['Non-KRAB Cells'])
hold off
print(fullfile(realfnout, ['tj_allmice_maxallsessions_green_.pdf']), '-dpdf', '-bestfit')
...
title(['KRAB Cells'])
hold off
print(fullfile(realfnout, ['tj_allmice_kallsessions_red_.pdf']), '-dpdf', '-bestfit')
...
title(['Non-KRAB Cells'])
hold off
print(fullfile(realfnout, ['tj_allmice_kallsessions_green_.pdf']), '-dpdf', '-bestfit')
...
title(['KRAB Cells'])
hold off
print(fullfile(realfnout, ['tj_allmice_reliabilityallsessions_red_.pdf']), '-dpdf', '-bestfit')
...
title(['Non-KRAB Cells'])
hold off
print(fullfile(realfnout, ['tj_allmice_reliabilityallsessions_green_.pdf']), '-dpdf', '-bestfit')
...
set(j, 'LineStyle', '--', 'Color', 'r', 'LineWidth',2);
legend(['Arc Prom (KRAB)'], ['LacZ (KRAB)'], 'Location', 'southeast')
xlim([0 90])
xlabel(['Change in Pref Ori'])
ylabel(['% of cells'])
title(['KRAB Cells'])
hold off
print(fullfile(realfnout, ['tj_allmice_changepref_red_.pdf']), '-dpdf', '-bestfit')
...
legend(['Arc Prom (Non-KRAB)'], ['LacZ (Non-KRAB)'], 'Location', 'southeast')
xlim([0 90])
xlabel(['Change in Pref Ori'])
ylabel(['% of cells'])
title(['Non-KRAB Cells'])
hold off
print(fullfile(realfnout, ['tj_allmice_changepref_green_.pdf']), '-dpdf', '-bestfit')

%%
fig = figure;
% sgtitle('Pref Ori Changes')
% a=subplot(2,2,1)
h=cdfplot(arc_green_all_pref_d);
set(h, 'LineStyle', '-', 'Color', 'g', 'LineWidth',2);
hold on
j=cdfplot(arc_red_all_pref_d);
set(j, 'LineStyle', '-', 'Color', 'r', 'LineWidth',2);
l=cdfplot(lacz_green_all_pref_d);
set(l, 'LineStyle', '--', 'Color', 'g', 'LineWidth',2);
m=cdfplot(lacz_red_all_pref_d);
set(m, 'LineStyle', '--', 'Color', 'r', 'LineWidth',2);
legend(['Arc Mice (Non-KRAB)'], ['Arc Mice (KRAB)'], ['LacZ Mice (Non-KRAB)'], ['LacZ Mice (KRAB)'], 'Location', 'southeast')
xlim([0 90])
xlabel(['Change in Pref Ori'])
ylabel(['% of cells'])
title([])
...
print(fullfile(realfnout, ['tj_allmice_changeprefalldaysallcells_.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_allmice_changek_red.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_allmice_changemax_red.pdf']), '-dpdf', '-bestfit')
...
set(h, 'LineStyle', '-', 'Color', 'r', 'LineWidth',2);
hold on
j=cdfplot(arc_green_d_k_all);
set(j, 'LineStyle', '-', 'Color', 'g', 'LineWidth',2);
legend(['All Sessions (KRAB)'], ['All Sessions (Non-KRAB)'], 'Location', 'southeast')
xlim([0 30])
xlabel(['Change in k Value'])
ylabel(['% of cells'])
title(['Arc Promoter Mice'])
...
print(fullfile(realfnout, ['tj_arcmice_changek.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tj_arcmice_changemax.pdf']), '-dpdf', '-bestfit')


%%

save(fullfile(realfnout, ['_tj_pooled_pref_data.mat']), 'arc_red_d1_d2_pref_d_all', 'arc_red_d1_d3_pref_d_all', 'arc_green_d1_d2_pref_d_all', 'arc_green_d1_d3_pref_d_all', ...
...
save(fullfile(realfnout, ['_tj_pooled_kmax_data.mat']), 'arc_red_k_all', 'arc_green_k_all', 'lacz_red_k_all', 'lacz_green_k_all', 'arc_red_d_k_all', 'arc_green_d_k_all', ...
...
save(fullfile(realfnout, ['_tj_pooled_kmax_day1_data.mat']), 'arc_red_d1_k_all', 'arc_green_d1_k_all', 'lacz_red_d1_k_all', 'lacz_green_d1_k_all', ...
    'arc_red_d1_max_all', 'arc_green_d1_max_all', 'lacz_red_d1_max_all', 'lacz_green_d1_max_all')

save(fullfile(realfnout, ['_tj_medsplit_pref_data.mat']), 'arc_red_bot_d1_d2_pref_d_all', 'arc_red_bot_d1_d3_pref_d_all', 'arc_green_bot_d1_d2_pref_d_all', 'arc_green_bot_d1_d3_pref_d_all', ...
...
save(fullfile(realfnout, ['_tj_k_medsplit_pref_data.mat']), 'arc_red_wide_d1_d2_pref_d_all', 'arc_red_wide_d1_d3_pref_d_all', 'arc_red_wide_pref_d_all', 'arc_green_wide_d1_d2_pref_d_all', ...
...
set(h, 'LineStyle', '-', 'Color', 'r', 'LineWidth',2);
hold on
j=cdfplot(lacz_red_bot_pref_d_all);
set(j, 'LineStyle', '--', 'Color', 'r', 'LineWidth',2);
l=cdfplot(arc_green_bot_pref_d_all);
set(l, 'LineStyle', '-', 'Color', 'g', 'LineWidth',2);
m=cdfplot(lacz_green_bot_pref_d_all);
set(m, 'LineStyle', '--', 'Color', 'g', 'LineWidth',2);
legend(['Arc Promoter (KRAB)'], ['LacZ (KRAB)'], ['Arc Promoter (Non-KRAB)'], ['LacZ (Non-KRAB)'], 'Location', 'southeast')
xlim([0 90])
xlabel(['Change in Pref Ori'])
ylabel(['% of cells'])
title(['Bottom 50%'])
...
print(fullfile(realfnout, ['allmice_bot50_changepref_allcells.pdf']), '-dpdf', '-bestfit')


fig = figure;
% sgtitle('k values')
% a=subplot(2,2,1)
h=cdfplot(arc_red_top_pref_d_all);
set(h, 'LineStyle', '-', 'Color', 'r', 'LineWidth',2);
hold on
j=cdfplot(lacz_red_top_pref_d_all);
set(j, 'LineStyle', '--', 'Color', 'r', 'LineWidth',2);
l=cdfplot(arc_green_top_pref_d_all);
set(l, 'LineStyle', '-', 'Color', 'g', 'LineWidth',2);
m=cdfplot(lacz_green_top_pref_d_all);
set(m, 'LineStyle', '--', 'Color', 'g', 'LineWidth',2);
legend(['Arc Promoter (KRAB)'], ['LacZ (KRAB)'], ['Arc Promoter (Non-KRAB)'], ['LacZ (Non-KRAB)'], 'Location', 'southeast')
...
print(fullfile(realfnout, ['allmice_top50_changepref_allcells.pdf']), '-dpdf', '-bestfit')
...
set(h, 'LineStyle', '-', 'Color', 'r', 'LineWidth',2);
hold on
j=cdfplot(lacz_red_wide_pref_d_all);
set(j, 'LineStyle', '--', 'Color', 'r', 'LineWidth',2);
l=cdfplot(arc_green_wide_pref_d_all);
set(l, 'LineStyle', '-', 'Color', 'g', 'LineWidth',2);
m=cdfplot(lacz_green_wide_pref_d_all);
set(m, 'LineStyle', '--', 'Color', 'g', 'LineWidth',2);
legend(['Arc Promoter (KRAB)'], ['LacZ (KRAB)'], ['Arc Promoter (Non-KRAB)'], ['LacZ (Non-KRAB)'], 'Location', 'southeast')
xlim([0 90])
xlabel(['Change in Pref Ori'])
...
print(fullfile(realfnout, ['allmice_wide_changepref_allcells.pdf']), '-dpdf', '-bestfit')


fig = figure;
% sgtitle('k values')
% a=subplot(2,2,1)
h=cdfplot(arc_red_sharp_pref_d_all);
set(h, 'LineStyle', '-', 'Color', 'r', 'LineWidth',2);
hold on
j=cdfplot(lacz_red_sharp_pref_d_all);
set(j, 'LineStyle', '--', 'Color', 'r', 'LineWidth',2);
l=cdfplot(arc_green_sharp_pref_d_all);
set(l, 'LineStyle', '-', 'Color', 'g', 'LineWidth',2);
m=cdfplot(lacz_green_sharp_pref_d_all);
set(m, 'LineStyle', '--', 'Color', 'g', 'LineWidth',2);
legend(['Arc Promoter (KRAB)'], ['LacZ (KRAB)'], ['Arc Promoter (Non-KRAB)'], ['LacZ (Non-KRAB)'], 'Location', 'southeast')
...
print(fullfile(realfnout, ['allmice_sharp_changepref_allcells.pdf']), '-dpdf', '-bestfit')
...
figure;
subplot(2,2,1)
scatter(arc_green_k_all, arc_green_max_all, [], 'green')
xlabel(['k Value'])
ylabel(['Max dF/F Value'])
title(['All Green Cells'], ['r = ' num2str(corr(arc_green_k_all', arc_green_max_all'))])

% figure;
subplot(2,2,2)
scatter(arc_red_k_all, arc_red_max_all, [], 'red')
xlabel(['k Value'])
ylabel(['Max dF/F Value'])
title(['All Red Cells'], ['r = ' num2str(corr(arc_red_k_all', arc_red_max_all'))])


arc_green_notmaxk = find(arc_green_k_all <= 29);
arc_green_maxk = find(not(arc_green_k_all <= 29));
arc_red_notmaxk = find(arc_red_k_all <= 29);
arc_red_maxk = find(not(arc_red_k_all <= 29));


% figure;
subplot(2,2,3)
scatter(arc_green_k_all(arc_green_notmaxk), arc_green_max_all(arc_green_notmaxk), [], 'green')
xlabel(['k Value'])
ylabel(['Max dF/F Value'])
title(['Green Cells < 30 k'], ['r = ' num2str(corr(arc_green_k_all(arc_green_notmaxk)', arc_green_max_all(arc_green_notmaxk)'))])


% figure;
subplot(2,2,4)
scatter(arc_red_k_all(arc_red_notmaxk), arc_red_max_all(arc_red_notmaxk), [], 'red')
xlabel(['k Value'])
ylabel(['Max dF/F Value'])
title(['Red Cells < 30 k'], ['r = ' num2str(corr(arc_red_k_all(arc_red_notmaxk)', arc_red_max_all(arc_red_notmaxk)'))])
...
%%
save(fullfile(realfnout, ['_tj_reliabilitysplit_pref_data.mat']), 'arc_red_pref_bin1_reliability_all', 'arc_red_pref_bin2_reliability_all', 'arc_red_pref_bin3_reliability_all', ...
