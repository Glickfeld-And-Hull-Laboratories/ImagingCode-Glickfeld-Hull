...
fnout_ref = fullfile('\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_Staff\home\lindsey\Analysis\2P',[date '_' mouse], [date '_' mouse '_' ref_str]);
if doNewD1
...
%    clear out outs
    ...
    load(fullfile(fnout_ref, [date '_' mouse '_' ref_str '_reg_shifts.mat']), 'data_avg')
...
% load masks
load(fullfile(fnout_ref, [date '_' mouse '_' ref_str '_mask_cell.mat']), 'data_dfof_max', 'mask_cell', 'mask_np')
