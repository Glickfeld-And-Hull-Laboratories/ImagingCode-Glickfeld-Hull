...
title(['KRAB Cells'])
hold off
print(fullfile(realfnout, ['tjmice_ksplit_reliability_redcells.pdf']), '-dpdf', '-bestfit')
...
title(['KRAB Cells'])
hold off
print(fullfile(realfnout, ['tjmice_maxsplit_reliability_redcells.pdf']), '-dpdf', '-bestfit')
...
print(fullfile(realfnout, ['tjmice_weaksharp_overlap_allcells_bar.pdf']), '-dpdf', '-bestfit')

%%

save(fullfile(realfnout, ['_tj_pooled_reliability_overlap_data.mat']), 'arc_red_wide_reliability_all', 'arc_red_sharp_reliability_all', 'lacz_red_wide_reliability_all', 'lacz_red_sharp_reliability_all', ...
...
set(h, 'LineStyle', '-', 'Color', 'r', 'LineWidth',2);
hold on
j=cdfplot(lacz_red_wide_reliability_all);
set(j, 'LineStyle', '--', 'Color', 'r', 'LineWidth',2);
l=cdfplot(arc_green_wide_reliability_all);
set(l, 'LineStyle', '-', 'Color', 'g', 'LineWidth',2);
m=cdfplot(lacz_green_wide_reliability_all);
...
title(['Wide 50%'])
hold off
print(fullfile(realfnout, ['tjmice_wide_ksplit_reliability_ALLcells.pdf']), '-dpdf', '-bestfit')

fig = figure;
h=cdfplot(arc_red_sharp_reliability_all);
set(h, 'LineStyle', '-', 'Color', 'r', 'LineWidth',2);
hold on
j=cdfplot(lacz_red_sharp_reliability_all);
set(j, 'LineStyle', '--', 'Color', 'r', 'LineWidth',2);
l=cdfplot(arc_green_sharp_reliability_all);
set(l, 'LineStyle', '-', 'Color', 'g', 'LineWidth',2);
...
title(['Sharp 50%'])
hold off
print(fullfile(realfnout, ['tjmice_sharp_ksplit_reliability_ALLcells.pdf']), '-dpdf', '-bestfit')
