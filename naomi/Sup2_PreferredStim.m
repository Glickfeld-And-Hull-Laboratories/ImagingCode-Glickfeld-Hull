...
for i=1:size(Neuron.Neuron(3).Stim,2)
...
BLvsPS1(i,h)=ttest(Prestim',Peristim1','tail','left');
PPS1vsPS2(i,h)=ttest(Peristim1',Peristim2','tail','left');
APS1vsPS2(i,h)=ttest(Peristim1',Peristim2','tail','right');
...
%% On to AI information

%% first let's get the AI for stim driven neurons
