...
probfile = 'Z:\home\miaomiao\Archive\spykingCircus\miao_poly.prb';
...
for i_temp = 1:N_temp
    ...
    [pt_ms(i_temp,1),pt_ratio(i_temp,1),pt_distance(i_temp,1),asym(i_temp,1),hfw(i_temp,1)]=waveStats(Temp_big(:,i_temp));
...
save([folderPath(1:folderIdx(end-1)) folderPath(folderIdx(5)+1:folderIdx(6)-1) ...
    '_D00' folderPath(folderIdx(7)-1) '_spikes'],'spikes');
end
