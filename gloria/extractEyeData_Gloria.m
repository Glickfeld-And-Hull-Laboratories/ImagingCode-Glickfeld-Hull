function Eye_data = extractEyeData(data,rad_range,fnout, mouse, datemouse, datemouserun)
...
xlabel('Metric')
movegui('center')
print(fullfile(fnout, mouse, datemouse, datemouserun,[datemouserun '_eyeHistograms.pdf']),'-dpdf','-fillpage')

x1 = find(isnan(Area));
x2 = find(~isnan(Area));
x3 = unique([find(Val<0.1); find(Val<0.20 & SNR<1.5)]);
...
print(fullfile(fnout, mouse, datemouse, datemouserun, [datemouserun '_pupilbadFrames.pdf']),'-dpdf','-fillpage')
...
print(fullfile(fnout, mouse, datemouse, datemouserun, [datemouserun '_pupilgoodFrames.pdf']),'-dpdf','-fillpage')
