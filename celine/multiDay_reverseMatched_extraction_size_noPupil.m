...
for id = 1:nd
    ...
    resp_sig = data_resp(:,:,:,:,1).*h; %resp_sig is nCells x nDir x nCons x nSizes
...
save(fullfile(fn_multi,'tc_keep.mat'),'fullTC_keep','pref_responses_stat', ...
   'pref_responses_loc','resp_keep', ...
    ...
    'nTrials','tc_trial_avrg_stat','tc_trial_avrg_loc', 'green_keep_logical', ...
