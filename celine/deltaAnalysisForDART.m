...
norm_delta_stat=(pref_responses_stat_concat{post}-pref_responses_stat_concat{pre})./(pref_responses_stat_concat{post}+pref_responses_stat_concat{pre});
...
figure
subplot(1,2,1) %for the second day
errorbar(cons,conResp_red_avrg_stat{PEG},conResp_red_se_stat{PEG},'k');
hold on
errorbar(cons,conResp_red_avrg_stat{DART},conResp_red_se_stat{DART},'b');
title('SST')
...
subplot(1,2,2) %for the first day
errorbar(cons,conResp_green_avrg_stat{PEG},conResp_green_se_stat{PEG},'--k');
hold on
errorbar(cons,conResp_green_avrg_stat{DART},conResp_green_se_stat{DART},'--b');
title('Pyr')
xlabel('contrast') 
