...
instructions.sess_list = [70 68]; % 
instructions.runOnset_sess_list = [70 68]; %skipping sessions that didn't have any running onsets
instructions.ds = 'DART_V1_atropine_Celine';
instructions.experimentFolder = 'VIP_atropine';
...
% This is for VIP cre mice that got atropine-DART, collected by Jerry Hu in
% January 2025.