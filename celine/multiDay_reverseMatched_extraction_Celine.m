...
%% DON'T NEED TO RUN REST OF SCRIPT RIGHT NOW
% 
...
%             ind_stat_hiPupil = intersect(ind, find(PIx_stat{1,id}));
%             ind_stat_lowPupil = intersect(ind, find(PIx_stat{2, id}));
...
%             ind_stat_hiPupil = intersect(stat_inds, find(PIx_stat{1,id}));
%             ind_stat_lowPupil = intersect(stat_inds, find(PIx_stat{2,id}));
% 
