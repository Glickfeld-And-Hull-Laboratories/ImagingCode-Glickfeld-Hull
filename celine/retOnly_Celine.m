...
fprintf('Plot tc_dfof for all stims of cell 10/n')
figure;
for iCell = 10
    for iCond = 1:nStim
        subplot(7,7,iCond)
...
fprintf('Begin shuffling.../n')
for count_shuf = 0:Nshuf
    fprintf(['count_shuf: ' num2str(count_shuf) '/' num2str(Nshuf) '/n'])
    ...
    if count_shuf == 0  
        set(gcf, 'Position', [0 0 800 1000]);
        fn_out = fullfile(isilonName, '/home/ACh/Analysis/2P_analysis', mouse, date, RetImgFolder, [date '_' mouse '_' run_str '_RFfits' num2str(ifig) '.pdf']);
        print(fn_out,'-dpdf')
    end
end
fprintf('Shuffling done, saving fit results/n')

fn_out = fullfile(isilonName, '/home/ACh/Analysis/2P_analysis', mouse, date, RetImgFolder, [date '_' mouse '_' run_str '_Fit_struct.mat']);
...
fprintf(['#Good cells = ' num2str(length(goodfit_ind)) ' (first pass).../nNow removing RFs at ret perimeter/n'])
...
fn_out = fullfile(isilonName, '/home/ACh/Analysis/2P_analysis', mouse, date, RetImgFolder, [date '_' mouse '_' run_str '_lbub_fits.mat']);
...
set(gcf, 'Position', [0 0 800 1000]);
fn_out = fullfile(isilonName, '/home/ACh/Analysis/2P_analysis', mouse, date, RetImgFolder, [date '_' mouse '_' run_str '_RFs.pdf']);
print(fn_out,'-dpdf')
