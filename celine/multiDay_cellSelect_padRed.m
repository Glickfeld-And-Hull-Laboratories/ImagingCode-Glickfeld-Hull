...
mask_all_OG = mask_all;
%first I'll save a copy of the original, un-expanded masks for comparison
mask_all = mask_all+imCellBuffer(mask_all,1); %using imcellbuffer to expand the mask around the red roi's since red signal is localized to the nucleus
...
save(fullfile(fnout, 'mask_cell.mat'), 'data_dfof', 'mask_cell', 'mask_cell_red', 'mask_np','mask_label','mask_all_OG')
