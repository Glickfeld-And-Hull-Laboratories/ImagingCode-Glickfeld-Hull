function [finalArray] = singleDay_extract_all_trial_resp(nOri,nCon,nCells,nTrials,resp_matrix)
...
finalArray=NaN((nCells*nTrials),5);
counter=1;
   for iOri=1:nOri
        for iCon = 1:nCon
            %turn the data for this condition and day into an array
            thisArray1 = cell2mat(resp_matrix(iOri,iCon));
