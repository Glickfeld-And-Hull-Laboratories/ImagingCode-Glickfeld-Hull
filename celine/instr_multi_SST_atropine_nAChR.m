...
instructions.sess_list = [78 77 74 72]; % 
instructions.runOnset_sess_list = [78 77 74] %skipping sessions that didn't have any running onsets
...
% This is for SOM cre mice that got both atropine-DART and nAChR-DART