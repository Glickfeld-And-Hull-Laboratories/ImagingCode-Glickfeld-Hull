%% Instruction sheet
instructions.sess_list=[47]; %the sessions to concatenate and analyze
...
instructions.targetSize = [7.5 15.0 30.0000  60.0000 120.000]; %the sizes to analyze, in case not all datasets have the same set of sizes
instructions.frame_rate = 15;
%% Notes
% 42, mouse i2221, has sizes 30.0000  60.0000 120.000