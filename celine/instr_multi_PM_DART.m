%% Instruction sheet
instructions.sess_list=[42]; %the sessions to concatenate and analyze
...
instructions.targetSize = [30.0000  60.0000 120.000]; %the sizes to analyze, in case not all datasets have the same set of sizes
