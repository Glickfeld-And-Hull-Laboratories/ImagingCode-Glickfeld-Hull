...
%
clear mouse iSess nKeep iSess fn_multi cons oris
...
for id = 1:nd
    osi_stat{id}=(pref_nonPref_stat_concat{id}(:,1,:)-pref_nonPref_stat_concat{id}(:,2,:))./(pref_nonPref_stat_concat{id}(:,1,:)+pref_nonPref_stat_concat{id}(:,2,:));
    osi_loc{id}=(pref_nonPref_loc_concat{id}(:,1,:)-pref_nonPref_loc_concat{id}(:,2,:))./(pref_nonPref_loc_concat{id}(:,1,:)+pref_nonPref_loc_concat{id}(:,2,:));
end

for iCon = 1:nCon
    figure
    subplot(2,2,1)
    scatter(osi_stat{pre}(green_ind_concat,:,iCon),osi_stat{post}(green_ind_concat,:,iCon))
    title('Pyr Stationary')
    xlim([-1 1])
    ylim([-1 1])
    set(gca, 'TickDir', 'out')
    ...
    subplot(2,2,2)
    scatter(osi_stat{pre}(red_ind_concat,:,iCon),osi_stat{post}(red_ind_concat,:,iCon))
    title('SST Stationary')
    xlim([-1 1])
    ylim([-1 1])
    set(gca, 'TickDir', 'out')
    ...
    subplot(2,2,3)
    scatter(osi_loc{pre}(green_ind_concat,:,iCon),osi_loc{post}(green_ind_concat,:,iCon))
    title('Pyr Running')
    xlim([-1 1])
    ylim([-1 1])
    set(gca, 'TickDir', 'out')
    ...
    subplot(2,2,4)
    scatter(osi_loc{pre}(red_ind_concat,:,iCon),osi_loc{post}(red_ind_concat,:,iCon))
    title('SST Running')
    xlim([-1 1])
    ylim([-1 1])
    set(gca, 'TickDir', 'out')
    ...
    sgtitle(['Pref - nonPref, ' num2str(cons(iCon))])

    print(fullfile(fnout,[num2str(cons(iCon)),'prefVsnonPref.pdf']),'-dpdf','-bestfit')
