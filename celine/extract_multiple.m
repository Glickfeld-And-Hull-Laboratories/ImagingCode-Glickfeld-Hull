clear all
clear global
sessList = [138 142 163 171 178 190 294 307 323 333];
...
%pupilThreshold_low=prctile(pupilBothDays,30);
...
% 
%     temp_pref_peak_stat=nan(nKeep,nCon,1);
%     temp_pref_peak_loc=nan(nKeep,nCon,1);
% 
