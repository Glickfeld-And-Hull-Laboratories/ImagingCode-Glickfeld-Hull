...
if strcmp(ds,'FSAV_attentionV1') || strcmp(ds,'FSAV_V1_100ms') || strcmp(ds,'FSAV_V1_SOM')
    fnout = fullfile(rc.lindseyAnalysis,'behavior',...
        [titleStr '_']); 
    bxExpt = true;
elseif strcmp(ds,'FSAV_V1_100ms_naive')
    fnout = fullfile(rc.lindseyAnalysis,'naive',...
        [titleStr '_']);     
    bxExpt = false;
end
...
print([fnout 'adaptationByCycAndOri_all'],'-dpdf','-fillpage')
...
figYAxis([],'Norm dF/F',[0 1])
figAxForm
print([fnout 'adaptationByCycAndOri_AVG_all'],'-dpdf','-fillpage')
...
title('Stim 1')
print([fnout 'Stim1TCs_all'],'-dpdf','-fillpage')
%% Only tuned cells
figure
suptitle([ds ': Tuned, Min. & First Stim Resp. Neurons'])
ind = cellInfo.firstRespCells & cellInfo.minRespCells & cellInfo.isTuned;
...
print([fnout 'adaptationByCycAndOri_tuned'],'-dpdf','-fillpage')
...
figYAxis([],'Norm dF/F',[0 1])
figAxForm
print([fnout 'adaptationByCycAndOri_AVG_tuned'],'-dpdf','-fillpage')
%% 
if ~bxExpt
