...
% AL L2/3 -- 17 27 58 70 74 90 92 94
% LM L2/3 -- 19 30 60 73 78 87 88 91
% PM L2/3 -- 97 102 103 104 122 123 124 134 136 137 140

expts = [97 102 103 104 122 123 124 134 136 137 140] ;
...
for iexp = expts
    ...
    save(fullfile(summaryDir,[svName '_Summary_' inj_area  '_' driver '.mat']), 'avg_resp_dir_all', 'ang_dir_all', 'ang_ori_all', 'g_dsi_all', 'g_osi_all', 'grat_pref_all', 'plaid_pref_all', 'mean_avg_all', 'std_avg_all', 'prefDir_resamp_all', 'sig_dir','sig_stim','plaid_corr_all', 'red_cells_all', 'ZpZcPWdist_all', 'b_all_sh', 'amp_all_sh', 'Rsq_all_sh', 'sse_all_all_sh','dir_yfits','R2_all','u2_all','dir_b_all', 'k1_all', 'R1_all', 'u1_all', 'dir_Rsq_all', 'dir_sse_all', 'nCells', 'Zp_all', 'Zc_all', 'PCI_all', 'b_all','amp_all','Rsq_all','yfit_all_all', 'sse_all_all', 'DSI_all','mouse_list', 'expts')
    %save(fullfile(summaryDir,[svName '_Summary_' inj_area '_' num2str(iexp) '.mat']), 'avg_resp_dir_all',  'ang_dir_all', 'ang_ori_all', 'g_dsi_all', 'g_osi_all', 'mean_avg_all', 'std_avg_all', 'prefDir_resamp_all','sig_dir','sig_stim','plaid_corr_all', 'red_cells_all', 'dir_yfits','ZpZcPWdist_all','R2_all','u2_all','dir_b_all', 'k1_all', 'R1_all', 'u1_all', 'dir_Rsq_all', 'dir_sse_all', 'nCells', 'Zp_all', 'Zc_all', 'PCI_all', 'b_all','amp_all','Rsq_all','yfit_all_all', 'sse_all_all', 'DSI_all','mouse_list')
