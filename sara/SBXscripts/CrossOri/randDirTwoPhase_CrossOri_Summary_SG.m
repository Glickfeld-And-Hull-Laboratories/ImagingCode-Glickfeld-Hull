...
summaryDir = fullfile(base, 'Analysis', '2P', 'CrossOri', 'RandDirSummary');
svName = 'randDirTwoPhase';
str = {'hiSF','lowSF'};

area_list = strvcat('AL');%,'LM');%,'AL','RL','PM');
...
%             if strcmp(expt(iexp).img_loc, area) & strcmp(expt(iexp).driver,driver)
                ...
                load(fullfile(base, 'Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_dirAnalysis.mat']));
