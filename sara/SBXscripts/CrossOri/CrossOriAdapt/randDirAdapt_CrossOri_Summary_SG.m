...
dataDir = '\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_staff\home\';
outDir = '\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_staff\home\sara\'; %change to your folder name
...
for iexp  =  1:nexp
    ...
    load(fullfile(dataDir, loc,'\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_respData.mat']))
    load(fullfile(dataDir, loc, '\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_dataStim.mat']))
    load(fullfile(dataDir, loc, '\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_stimData.mat']))
    load(fullfile(dataDir, loc, '\Analysis\2P', [date '_' mouse], [date '_' mouse '_' run_str], [date '_' mouse '_' run_str '_input.mat']))

    fprintf([mouse ' ' date ' ncells=' num2str(size(data_dfof_tc,2)) '\n'])
...
print(fullfile(outDir, 'Analysis\2P\CrossOri\RandDirAdaptSummary', 'randDirAdapt_polarByPref.pdf'),'-dpdf','-bestfit')
