...
%save variables
save([analysis_out date '_img' mouse '\' date '_img' mouse '_' run '_spk_deconvolve_threshold' num2str(thresholdDeco) '.mat' ],'thresholdDeco',...
...
baseline_thres = str2double(input('Set the baseline: '));
%baseline_thres = [];
...
load([analysis_out date '_img' mouse '\getTC_' run '\' date '_img' mouse '_' run '_nPCA' num2str(nPCA) '_mu' num2str(mu) '_nIC' num2str(nIC) '_thresh' num2str(cluster_threshold) '_coor' num2str(threshold) '_mask3D.mat'], 'mask3D');
mask3D_final = mask3D; mask3D_final(:,:,badPCs) = [];
save([analysis_out date '_img' mouse '\getTC_' run '\' date '_img' mouse '_' run '_nPCA' num2str(nPCA) '_mu' num2str(mu) '_nIC' num2str(nIC) '_thresh' num2str(cluster_threshold) '_coor' num2str(threshold) '_mask3D_final.mat'], 'mask3D_final','-append');
save([analysis_out date '_img' mouse '\' date '_img' mouse '_' run '_deconvolution_thresh', num2str(thresholdDeco), '_TCave_cl.mat'],...
    'TCave_cl','thresholdDeco','badPCs','nobase_cell','low_Fcell','nobase_thres','baseline_thres','all_TCave_cl','goodcells');
save([analysis_out date '_img' mouse '\' date '_img' mouse '_' run '_spk_deconvolve_threshold' num2str(thresholdDeco) '.mat' ],'FRstay_cell_cl', ...
...
savefig([analysis_out date '_img' mouse '\' date '_img' mouse '_' run '_mask_wdendrites_badcells.fig']);
