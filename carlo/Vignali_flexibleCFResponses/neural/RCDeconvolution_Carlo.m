...
thresholdDeco = -3; %don't change this value across animals
...
load([analysis_out date '_img' mouse '\getTC_' run '\' date ...
    '_img' mouse '_' run '_nPCA' num2str(nPCA) '_mu' num2str(mu) ...
