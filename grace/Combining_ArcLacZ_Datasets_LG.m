...
%     totCells = 0;
    ...
    maxRespD2all{igrna} = [];
    maxRespD3all{igrna} = [];
    signal_half1_all{igrna} = [];
    signal_half2_all{igrna} = [];
    signal_half3_all{igrna} = [];
    signal_day_half2_all{igrna} = [];
    signal_day_half3_all{igrna} = [];
    prefOriD1all{igrna} = [];
    prefOriD2all{igrna} = [];
    prefOriD3all{igrna} = [];
    k1_all{igrna} = [];
    ...
    mouse_list{igrna} = [];
    for iexp = 1:nexp
        if strcmp(expt(iexp).driver,grna)
            mouse = expt(iexp).mouse;
            mouse_list{igrna} = strvcat(mouse_list{igrna}, mouse);
            date = expt(iexp).date;
...
%             time = expt(iexp).coTime;
            ...
            prefOriD1all{igrna} = [prefOriD1all{igrna} prefOriD1];
            prefOriD2all{igrna} = [prefOriD2all{igrna} prefOriD2];
            prefOriD3all{igrna} = [prefOriD3all{igrna} prefOriD3];
            avgRespD1all{igrna} = [avgRespD1all{igrna} avgRespD1'];
            avgRespD2all{igrna} = [avgRespD2all{igrna} avgRespD2'];
            avgRespD3all{igrna} = [avgRespD3all{igrna} avgRespD3'];
            maxRespD1all{igrna} = [maxRespD1all{igrna} maxRespD1'];
            maxRespD2all{igrna} = [maxRespD2all{igrna} maxRespD2'];
            maxRespD3all{igrna} = [maxRespD3all{igrna} maxRespD3'];
            NR1_all{igrna} = vertcat(NR1_all{igrna},NR1);
            NR2_all{igrna} = vertcat(NR2_all{igrna},NR2);
            NR3_all{igrna} = vertcat(NR3_all{igrna},NR3);
            k1_all{igrna} = [k1_all{igrna} k1];
            k2_all{igrna} = [k2_all{igrna} k2];
            k3_all{igrna} = [k3_all{igrna} k3];
            s1_all{igrna} = [s1_all{igrna} s'];
            s2_all{igrna} = [s2_all{igrna} s2'];
            s3_all{igrna} = [s3_all{igrna} s3'];
            h1_all{igrna} = [h1_all{igrna} h1];
            h2_all{igrna} = [h2_all{igrna} h2];
            h3_all{igrna} = [h3_all{igrna} h3];
            signal_half1_all{igrna} = [signal_half1_all{igrna} signal_half1'];
            signal_day_half2_all{igrna} = [signal_day_half2_all{igrna} signal_day_half2'];
            signal_day_half3_all{igrna} = [signal_day_half3_all{igrna} signal_day_half3'];
            OSI1_all{igrna} = [OSI1_all{igrna} osi1'];
            OSI2_all{igrna} = [OSI2_all{igrna} osi2'];
            OSI3_all{igrna} = [OSI3_all{igrna} osi3'];
            DSI1_all{igrna} = [DSI1_all{igrna} dsi1'];
            DSI2_all{igrna} = [DSI2_all{igrna} dsi2'];
            DSI3_all{igrna} = [DSI3_all{igrna} dsi3'];
            end
        end
end
...
title('')
legend(grna_list,'location','southeast')
subplot(2,2,2)
for i = 1:2
    cdfplot(OSI1_all{i})
    hold on
...
subplot(2,2,4)
for i = 1:2
    cdfplot(maxRespD1all{i})
    hold on
end
xlabel('Max dF/F')
title('')
print('\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_Staff\home\lindsey\Talks\LabMeeting\220329\Summary_ArcVLacZ_tuning.pdf','-dpdf','-bestfit')
%%
