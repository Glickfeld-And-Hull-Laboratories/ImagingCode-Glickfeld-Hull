...
i = 5;
subplot(3,3,1)
shadedErrorBar(tt', resp_tc_all(:,ind_h(i),1,nStimCon,1,1), resp_tc_all(:,ind_h(i),1,nStimCon,1,2),{['b-'], 'markerfacecolor', 'b'});
hold on
shadedErrorBar(tt, resp_tc_all(:,ind_h(i),nMaskCon,1,1,1), resp_tc_all(:,ind_h(i),nMaskCon,1,1,2),{['r-'], 'markerfacecolor','r'});
xlabel('Time (ms)')
ylabel('dF/F')
title('Stim/Mask')
ylim([-0.1 1.2])
...
figure;
subplot(3,3,1)
shadedErrorBar(tt', resp_tc_all(:,ind_l(i),1,nStimCon,1,1), resp_tc_all(:,ind_l(i),1,nStimCon,1,2),{['b-'], 'markerfacecolor', 'b'});
hold on
shadedErrorBar(tt, resp_tc_all(:,ind_l(i),nMaskCon,1,1,1), resp_tc_all(:,ind_l(i),nMaskCon,1,1,2),{['r-'], 'markerfacecolor','r'});
xlabel('Time (ms)')
ylabel('dF/F')
title('Stim/Mask')
ylim([-0.1 1.2])
...
print(fullfile(summaryDir_F4, 'Figure4_SineAmplitudeBaseline_Summary.pdf'),'-dpdf','-bestfit')
...
print(fullfile(summaryDir_F4, 'Figure4_plaidSIOSI_Summary.pdf'),'-dpdf','-bestfit')
savefig(fullfile(summaryDir_F4, 'Figure4_plaidSIOSI_Summary.fig'))
...
ylabel('Fraction of cells')
xlim([-1 1])
print(fullfile(summaryDir_F4, 'Figure4_SI_allVpref_Summary.pdf'),'-dpdf','-bestfit')
savefig(fullfile(summaryDir_F4, 'Figure4_allVpref_Summary.fig'))
...
print(fullfile(summaryDir_F4, 'Figure4_allPhaseSIOSI_Summary.pdf'),'-dpdf','-bestfit')
savefig(fullfile(summaryDir_F4, 'Figure4_allPhaseSIOSI_Summary.fig'))
...
print(fullfile(summaryDir_F4, 'Figure4_f2f1_Summary.pdf'),'-dpdf','-bestfit')
savefig(fullfile(summaryDir_F4, 'Figure4_f2f1_Summary.fig'))
