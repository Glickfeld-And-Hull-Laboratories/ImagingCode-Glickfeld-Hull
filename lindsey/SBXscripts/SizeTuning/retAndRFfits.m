...
fprintf('\nBegin registering...\n')
if exist(fullfile(fnout, datemouse, datemouserun), 'dir')
...
% start with average
fprintf('\nFirst Step: Average\n')
mask_data_temp = mean(data_reg,3);
...
set(gcf, 'Position', [0 0 800 1000]);
print(fullfile(fnout, datemouse, datemouserun, [datemouserun '_FOV_overlay.pdf']), '-dpdf')

mask_np = imCellNeuropil(mask_cell, 3, 5);
save(fullfile(fnout, datemouse, datemouserun, [datemouserun '_mask_cell.mat']), 'mask_cell', 'mask_np', '-v7.3')
...
clear tc_mat tc_f fulltc_mat fulltc_f data_reg
...
load(fullfile(fnout, datemouse, datemouserun, [datemouserun '_mask_cell.mat']))
