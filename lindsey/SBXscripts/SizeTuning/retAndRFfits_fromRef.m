...
date = expt(iexp).date;
ImgFolder = cell2mat(expt(iexp).ret2Folder);
time = cell2mat(expt(iexp).ret2Time);
...
fprintf(['2P imaging second retinotopy - by KM, Glickfeld Lab\nSelected data:\nMouse: ' mouse '\nDate: ' date '\nExperiments:\n'])
for irun=1:nrun
...
if input.doRetStim
    ...
    % print to pdf
    print(fullfile(fnout, datemouse, datemouserun, [datemouserun '_FOV_resp_Ret.pdf']), '-dpdf')
...
set(gcf, 'Position', [0 0 800 1000]);
print(fullfile(fnout, datemouse, datemouserun, [datemouserun '_FOVresp.pdf']), '-dpdf')
save(fullfile(fnout, datemouse, datemouserun, [datemouserun '_FOVs.mat']), 'data_dfof_avg', 'Azs', 'Els','Stims')
...
set(gcf, 'Position', [0 0 800 1000]);
print(fullfile(fnout, datemouse, datemouserun, [datemouserun '_Tuning' num2str(f) '.pdf']), '-dpdf')
save(fullfile(fnout, datemouse, datemouserun, [datemouserun '_Tuning.mat']), 'tc_dfof', 'tuning_mat', 'Stims', 'Ind_struct')
...
set(gcf, 'Position', [0 0 800 1000]);
fn_out = fullfile(fnout, datemouse, datemouserun, [datemouserun '_RFs.pdf']);
print(fn_out,'-dpdf')
...
ylabel('Peak dF/F')
set(gcf, 'Position', [0 0 800 1000]);
fn_out = fullfile(fnout, datemouse, datemouserun, [datemouserun '_RFdists.pdf']);
print(fn_out,'-dpdf')
...
print(fullfile(fnout, datemouse, datemouserun, [datemouserun '_retMap.pdf']), '-dpdf','-bestfit')
...
% load(fullfile(fnout, datemouse, datemouserun, [datemouserun '_FOVs.mat']))
% % _Tuning.mat: 'tc_dfof', 'tuning_mat', 'Stims', 'Ind_struct'
% load(fullfile(fnout, datemouse, datemouserun, [datemouserun '_Tuning.mat']))
...
%         if sp >36
%             set(gcf, 'Position', [0 0 800 1000]);
%             print(fullfile(fnout, datemouse, datemouserun, [datemouserun '_RawFit' num2str(f) '.pdf']), '-dpdf')
%             sp = 1;
%             f = f+1;
%             figure;
%         end
