...
%% i1326 200708 only 12 directions
% expt(1).mouse = 'i1326';
% expt(1).date = '200708';
...
%% i1329 200904 not good responses (maybe not AL)
% expt(16).mouse = 'i1329';
% expt(16).date = '200904';
% expt(16).img_loc  = {'AL'};
% expt(16).z = -200;
...
% expt(16).coFolder = {'003'};
% expt(16).coTime = {'1616'};
% expt(16).prFolder = {'004'};
% expt(16).prTime = {'1718'};
...
expt(23).driver = {'SLC'};
expt(23).indicator = {'tg';'GCaMP6s'};
expt(23).coFolder = {'002'};
expt(23).coTime = {'1635'};
expt(23).prFolder = {'003'};
expt(23).prTime = {'1738'};
...
expt(24).coFolder = {'004'};
expt(24).coTime = {'1327'};
expt(24).prFolder = {'005'};
expt(24).prTime = {'1429'};
...
expt(27).coFolder = {'003'};
expt(27).coTime = {'1336'};
expt(27).prFolder = {'004'};
expt(27).prTime = {'1438'};
...
expt(28).coFolder = {'003'};
expt(28).coTime = {'1409'};
expt(28).prFolder = {'004'};
expt(28).prTime = {'1510'};
...
expt(33).coFolder = {'003'};
expt(33).coTime = {'1207'};
expt(33).prFolder = {'004'};
expt(33).prTime = {'1310'};
...
expt(35).coFolder = {'006'};
expt(35).coTime = {'1706'};
expt(35).prFolder = {'007'};
expt(35).prTime = {'1810'};
...
expt(39).coTime = {'1456'};
expt(39).prFolder = {'003'}; %error with line number
expt(39).prTime = {'1632'};
...
expt(43).coTime = {'1154'};
expt(43).prFolder = {'003'}; 
expt(43).prTime = {'1318'};
expt(43).saveLoc = 'lindsey';
...
expt(44).coTime = {'1101'};
expt(44).prFolder = {'003'}; 
expt(44).prTime = {'1204'};
expt(44).saveLoc = 'lindsey';
...
expt(45).coTime = {'1339'};
expt(45).prFolder = {'003'}; 
expt(45).prTime = {'1442'};
expt(45).saveLoc = 'lindsey';
...
expt(46).coTime = {'1629'};
expt(46).prFolder = {'003'}; 
expt(46).prTime = {'1733'};
expt(46).saveLoc = 'lindsey';
...
expt(47).coTime = {'1251'};
expt(47).prFolder = {'003'}; 
expt(47).prTime = {'1352'};
expt(47).saveLoc = 'lindsey';
...
expt(48).coTime = {'1544'};
expt(48).prFolder = {'003'}; 
expt(48).prTime = {'1645'};
expt(48).saveLoc = 'lindsey';
...
% expt(49).coTime = {'1410'};
% expt(49).sfFolder = {'003'}; 
% expt(49).sfTime = {'1514'};
% expt(49).saveLoc = 'lindsey';
...
% expt(50).driver = {'SOM'};
% expt(50).indicator = {'tg';'GCaMP6f'};
% expt(50).sf = 0.05;
% expt(50).coFolder = {'002'};
% expt(50).coTime = {'1706'};
% expt(50).saveLoc = 'lindsey';
...
expt(51).coTime = {'1459'};
expt(51).prFolder = {'003'}; 
expt(51).prTime = {'1601'};
expt(51).saveLoc = 'lindsey';
...
expt(52).coTime = {'1102'};
expt(52).prFolder = {'003'}; 
expt(52).prTime = {'1205'};
expt(52).saveLoc = 'lindsey';
...
expt(53).coTime = {'0952'};
expt(53).prFolder = {'003'}; 
expt(53).prTime = {'1110'};
expt(53).saveLoc = 'lindsey';
...
expt(54).coTime = {'1404'};
expt(54).prFolder = {'003'}; 
expt(54).prTime = {'1505'};
expt(54).saveLoc = 'lindsey';
...
expt(55).coTime = {'1015'};
expt(55).prFolder = {'003'}; 
expt(55).prTime = {'1118'};
expt(55).saveLoc = 'lindsey';
...
expt(56).coTime = {'0937'};
expt(56).prFolder = {'003'}; 
expt(56).prTime = {'1040'};
expt(56).saveLoc = 'lindsey';
...
expt(57).coTime = {'0931'};
expt(57).prFolder = {'003'}; 
expt(57).prTime = {'1035'};
expt(57).saveLoc = 'lindsey';
...
expt(58).coTime = {'1158'};
expt(58).prFolder = {'003'}; 
expt(58).prTime = {'1310'};
expt(58).saveLoc = 'lindsey';
...
expt(59).coTime = {'0948'};
expt(59).prFolder = {'003'}; 
expt(59).prTime = {'1049'};
expt(59).saveLoc = 'lindsey';
...
expt(60).coTime = {'1216'};
expt(60).prFolder = {'003'}; 
expt(60).prTime = {'1324'};
expt(60).saveLoc = 'lindsey';
...
expt(61).driver = {'SLC'};
expt(61).indicator = {'tg';'GCaMP6s'};
expt(61).sf = 0.1;
expt(61).coFolder = {'002'};
expt(61).coTime = {'0940'};
expt(61).prFolder = {'003'}; 
expt(61).prTime = {'1042'};
expt(61).saveLoc = 'lindsey';
...
expt(62).driver = {'SLC'};
expt(62).indicator = {'tg';'GCaMP6s'};
expt(62).sf = 0.1;
expt(62).coFolder = {'002'};
expt(62).coTime = {'1044'};
expt(62).prFolder = {'003'}; 
expt(62).prTime = {'1146'};
expt(62).saveLoc = 'lindsey';
...
expt(63).driver = {'SLC'};
expt(63).indicator = {'tg';'GCaMP6s'};
expt(63).sf = 0.1;
expt(63).coFolder = {'002'};
expt(63).coTime = {'1326'};
expt(63).prFolder = {'003'}; 
expt(63).prTime = {'1427'};
expt(63).saveLoc = 'lindsey';
...
expt(64).driver = {'SOM'};
expt(64).indicator = {'tg';'GCaMP6f'};
expt(64).sf = 0.1;
expt(64).coFolder = {'002'};
expt(64).coTime = {'1154'};
expt(64).prFolder = {'003'}; 
expt(64).prTime = {'1256'};
expt(64).saveLoc = 'lindsey';
...
expt(65).driver = {'SOM'};
expt(65).indicator = {'tg';'GCaMP6f'};
expt(65).sf = 0.1;
expt(65).coFolder = {'002'};
expt(65).coTime = {'1449'};
expt(65).prFolder = {'003'}; 
expt(65).prTime = {'1550'};
expt(65).saveLoc = 'lindsey';
...
expt(66).driver = {'SOM'};
expt(66).indicator = {'tg';'GCaMP6f'};
expt(66).sf = 0.1;
expt(66).coFolder = {'002'};
expt(66).coTime = {'1050'};
expt(66).prFolder = {'003'}; 
expt(66).prTime = {'1155'};
expt(66).saveLoc = 'lindsey';
...
expt(67).driver = {'SOM'};
expt(67).indicator = {'tg';'GCaMP6f'};
expt(67).sf = 0.1;
expt(67).coFolder = {'002'};
expt(67).coTime = {'0951'};
expt(67).prFolder = {'003'}; 
expt(67).prTime = {'1057'};
expt(67).saveLoc = 'lindsey';
...
expt(68).driver = {'SOM'};
expt(68).indicator = {'tg';'GCaMP6f'};
expt(68).sf = 0.1;
expt(68).coFolder = {'002'};
expt(68).coTime = {'1249'};
expt(68).prFolder = {'003'}; 
expt(68).prTime = {'1350'};
expt(68).saveLoc = 'lindsey';
...
expt(69).driver = {'SOM'};
expt(69).indicator = {'tg';'GCaMP6f'};
expt(69).sf = 0.1;
expt(69).coFolder = {'002'};
expt(69).coTime = {'1020'};
expt(69).prFolder = {'003'}; 
expt(69).prTime = {'1121'};
...
expt(72).driver = {'PV'};
expt(72).indicator = {'AAV';'GCaMP6s'};
expt(72).sf = 0.1;
expt(72).coFolder = {'002'};
expt(72).coTime = {'1739'};
expt(72).saveLoc = 'lindsey';
...
expt(73).driver = {'PV'};
expt(73).indicator = {'AAV';'GCaMP6s'};
expt(73).sf = 0.1;
expt(73).coFolder = {'002'};
expt(73).coTime = {'1504'};
expt(73).copFolder = {'003'};
expt(73).copTime = {'1622'};
expt(73).saveLoc = 'lindsey';
...
expt(74).driver = {'PV'};
expt(74).indicator = {'AAV';'GCaMP6s'};
expt(74).sf = 0.1;
expt(74).coFolder = {'002'};
expt(74).coTime = {'1156'};
expt(74).prFolder = {'003'}; 
expt(74).prTime = {'1318'};
expt(74).saveLoc = 'lindsey';
...
expt(75).driver = {'PV'};
expt(75).indicator = {'AAV';'GCaMP6s'};
expt(75).sf = 0.1;
expt(75).coFolder = {'002'};
expt(75).coTime = {'1446'};
expt(75).prFolder = {'003'}; 
expt(75).prTime = {'1549'};
expt(75).saveLoc = 'lindsey';
