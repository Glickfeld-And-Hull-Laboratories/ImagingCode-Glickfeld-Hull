...
%% i1322 200715 TF- 1Hz, 0.05cpd- eye may not have been open- no resp cells
% expt(5).mouse = 'i1322';
% expt(5).date = '200715';
...
%% i1312 200719 TF- 1Hz, 0.05cpd- very noisy no responsive cells
% expt(8).mouse = 'i1312';
% expt(8).date = '200719';
...
expt(15).driver = {'EMX'};
expt(15).indicator = {'AAV';'GCaMP6s'};
expt(15).coFolder = {'003'};
expt(15).coTime = {'1040'};
expt(15).prFolder = {'004'};
expt(15).prTime = {'1138'};
expt(15).saveLoc = 'lindsey';


%% i1325 200726 TF- 1Hz, 0.05cpd
expt(16).mouse = 'i1325';
expt(16).date = '200726';
