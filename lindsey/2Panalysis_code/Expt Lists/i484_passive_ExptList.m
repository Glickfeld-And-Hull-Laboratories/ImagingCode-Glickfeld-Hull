...
expt(1).coFolder = {'002'};
expt(1).coTime = {'1542'};
expt(1).copFolder = {'003'};
expt(1).copTime = {'1645'};
expt(1).redImg = {'004','005'};
...
expt(2).coFolder = {'001'};
expt(2).coTime = {'1432'};
expt(2).copFolder = {'002'};
expt(2).copTime = {'1538'};
expt(2).redImg = {'003','004'};
...
expt(3).coFolder = {'002'};
expt(3).coTime = {'1109'};
expt(3).copFolder = {'003'};
expt(3).copTime = {'1211'};
expt(3).redImg = {'004','005'};
...
expt(5).coFolder = {'004'};
expt(5).coTime = {'1347'};
expt(5).copFolder = {'005'};
expt(5).copTime = {'1451'};
expt(5).redImg = {'006','007'};
...
expt(7).coFolder = {'008'};
expt(7).coTime = {'1637'};
expt(7).copFolder = {'009'};
expt(7).copTime = {'1741'};
expt(7).redImg = {'010','011'};
