...
%sessions = {'210909_img1098','210921_img1901'};
% CS1+GtACR2 after training
sessions = {'220323_img1914','220408_img1912','220411_img1915','210924_img1098','210929_img1901'};
% CS1 training without IO inhibition
%sessions = {'211006_img1098','211008_img1901'}; 

run = {'000','000','000','000','000','000'}; 
analysis_out    = '\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_Staff\home\shuyang\2P_analysis\';
color_code = 'b';
% fig_name = 'across_session_targetalign_spike_naive';
% data_file = 'across_sessions_RC_data_naive';
% fig_name = 'across_session_targetalign_spike_CS1_GtACR2trained';
 data_file = 'across_sessions_RC_data_CS1_GtACR2trained_allmice.mat';
%fig_name = 'across_session_targetalign_spike_plus7days_CS1trained';
%data_file = 'across_sessions_RC_data_plus7days_CS1trained.mat';

% target align average
target_align_events_all = cell(1,length(sessions));
nPCs_total = 0;
ntrials_total = 0;
nPCs = [];
for ii = 1:length(sessions) 
    ...
    target_align_events_all{ii} = mean_targetAlign_events;
end
...
save(fullfile([analysis_out '\across_sessions_RC_GtACR2\',data_file]),...
     'target_align_events_all');
