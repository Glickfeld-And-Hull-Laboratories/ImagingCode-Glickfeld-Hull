...
for ii = 1: length(sessions)
    ...
    spk_deconv_output = load([image_analysis_dest_deconv_sep sessions{ii} '_spk_deconvolve_staynrun_seperate.mat']);
...
path = 'Z:\Analysis\2P_MovingDots_Analysis\across_sessions\deconvolve_separate\';
...
for ii = 1:length(sessions) 
    %load things
    image_analysis_dest_deconv_sep = [image_analysis_base, sessions{ii}, '\deconvolution_sep\'];
    spike_output = load([image_analysis_dest_deconv_sep sessions{ii} '_spk_deconvolve_staynrun_seperate.mat']);
