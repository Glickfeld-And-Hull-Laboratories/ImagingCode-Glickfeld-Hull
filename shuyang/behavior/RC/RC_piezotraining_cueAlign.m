...
analysis_out = 'Z:\behavior_analysis\RC\sessions_&_summaries';
bdata_source = 'Z:\Data\behavior\RC\';
RC_fig_dir_base = 'Z:\behavior_analysis\RC\sessions_&_summaries\';
sessions = '210202_img1083';% for behavior data
mouse = '1083';
date = '210202';
run = '000';
cue = 3; % 1: CS1 2: CS2 3:CS1+CS2 4:interleave
...
cd(fullfile('Z:\Data\behavior\peizo_training\', img_fn));
...
% licking data---------------------------------------------------------------------------------------------------------------------------------------------
load(fullfile('Z:\behavior_analysis\RC\', [sessions '_licktimes.mat']));
