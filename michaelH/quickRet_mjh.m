...
for irun = 1:nrun
    ...
    %CD = ['G:\\duhs-user-nc1.dhe.duke.edu\dusom_glickfeldlab\All_Staff\home\ACh\Data\2P_images\' [date '_' mouse] '\' ImgFolder(irun,:)];
    CD = ['G:\home\ACh\Data\2p_data\' mouse '\' date '\' ImgFolder(irun,:)];
